...
export default function GameCard({ game }: GameCardProps) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col overflow-hidden rounded-lg border border-white/5 bg-slate-900/40 p-0 transition-all duration-300 hover:border-violet-500/30 hover:bg-slate-900 hover:shadow-xl hover:shadow-violet-500/5 hover:-translate-y-1"
    >
      {/* Thumbnail Container */}
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-slate-950">
        ...
        <div className="absolute inset-0 flex flex-col justify-between bg-slate-950/70 p-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100 z-10">
